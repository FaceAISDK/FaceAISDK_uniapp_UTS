import {AddFaceSearchFeature,FaceSearch,InsertFaceFeature,ResultJSON} from '../interface.uts'
...
//*******************************     下面是1:N 人脸搜索识别的方法（仅Android） ************************************************
  ...
  *  人脸搜索人脸特征更新同步
  */
 export const insertFaceFeature : InsertFaceFeature = function (faceID : string, faceFeature : string, tag : string, group : string, 
