...
**感谢点赞收藏**，如有问题可 [到GitHub提issues](https://github.com/FaceAISDK/FaceAISDK_uniapp_UTS/issues) , [邮件联系](mailto:FaceAISDK.Service@gmail.com) 或 Wv：FaceAISDK  
...
# 常见问题解决方法
 ...
 ## 1.UI交互效果不符合业务需求？
   目前插件只有字体主题颜色能修改，如果你要修改UI样式等需要自行修改原生代码封装插件
 ...
 ## 3.改动原生Kotlin/Swift 代码导致基座不能正常运行
   自定义基座制作过程/打好后不能再改动原生Kotlin/Swift代码，改动后需重新打包
