...
open class UniAppConfig : io.dcloud.uniapp.appframe.AppConfig {
    override var name: String = "人脸识别_UTS"
    override var appid: String = "__UNI__A6AD04B"
    override var versionName: String = "2025.11.03"
    override var versionCode: String = "20251103"
    override var uniCompilerVersion: String = "4.85"
    constructor() : super() {}
}
fun definePageRoutes() {
    __uniRoutes.push(UniPageRoute(path = "pages/index/index", component = GenPagesIndexIndexClass, meta = UniPageMeta(isQuit = true), style = _uM("navigationBarTitleText" to "FaceAISDK Demo演示")))
}
val __uniLaunchPage: Map<String, Any?> = _uM("url" to "pages/index/index", "style" to _uM("navigationBarTitleText" to "FaceAISDK Demo演示"))
fun defineAppConfig() {
