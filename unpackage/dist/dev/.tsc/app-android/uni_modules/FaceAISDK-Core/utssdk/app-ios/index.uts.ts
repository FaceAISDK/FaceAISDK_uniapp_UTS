	...
	UTSAndroid.onAppActivityResult((requestCode : Int, resultCode : Int, intentAct?: Intent) => {
		if (requestCode == 10086) {
			if(intentAct!=null){
				...
				__f__('log','at uni_modules/FaceAISDK-Core/utssdk/app-ios/index.uts:63',"添加人脸人脸："+resultJson)
				callback(resultJson)
			}else{
				const resultJson:ResultJSON={
					code:-1,
	...
	UTSAndroid.onAppActivityResult((requestCode : Int, resultCode : Int, intentAct?: Intent) => {
		if (requestCode == 10086) {
			if(intentAct!=null){
				...
				__f__('log','at uni_modules/FaceAISDK-Core/utssdk/app-ios/index.uts:143',"添加人脸人脸："+resultJson)
				callback(resultJson)
			}else{
				const resultJson:ResultJSON={
					code:-1,
